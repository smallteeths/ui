...
export default Component.extend({
  ...
  actions: {
    addLabel() {
      ...
      console.log(get(this, 'model._targetType'))
      switch (get(this, 'model._targetType')) {
      case 'node':
  ...
  isExpressionOrRules: computed('model._targetType', function() {
    return get(this, 'model._targetType') === 'metric' || get(this, 'model._targetType') === 'commonRules' || get(this, 'model._targetType') === 'normalEvent' || get(this, 'model._targetType') === 'warningEvent' || get(this, 'model._targetType') === 'cisScan' ;
  }),
