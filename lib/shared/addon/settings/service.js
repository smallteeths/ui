...
export default Service.extend(Evented, {
  ...
  globalMonitoringEnabledV2:  alias(`asMap.${ C.SETTING.GLOBAL_MONITORING_ENABLED_V2 }.value`),
  ...
  disablePasswordEncrypt:     alias(`asMap.${ C.SETTING.DISABLE_PASSWORD_ENCRYPT }.value`),
  uiFavicon:                  alias(`asMap.${ C.SETTING.UI_FAVICON }.value`),
