...
export default Mixin.create({
  ...
  minCpu: computed('clusterLevelMinCpu', 'enabled', 'level', 'preRequestsCpu', 'projectLevelMinCpu', 'requestsCpu', function() {
    ...
    if ( this.enabled ) {
      cpu = cpu - parseInt(this.preRequestsCpu || 0, 10)
  ...
  minMemory: computed('clusterLevelMinMemory', 'enabled', 'level', 'preRequestsMemory', 'projectLevelMinMemory', 'requestsMemory', function() {
    ...
    if ( this.enabled ) {
      memory = memory - parseInt(this.preRequestsMemory || 0, 10);
