...
export default Component.extend(ModalBase, {
  ...
  validate() {
    ...
    if ( get(this, 'useStorageClass') ) {
      ...
      const persistentVolume = this.persistentVolumeChoices.find((pv) => pv.value === this.model.volumeId) || {};

      set(pr, 'storageClassId', persistentVolume.storageClassId || null);
      set(pr, 'resources', { requests: Object.assign({}, persistentVolume.capacity), });
    }
