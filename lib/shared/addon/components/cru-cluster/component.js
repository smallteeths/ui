...
export default Component.extend(ViewNewEdit, ChildHook, {
  ...
  nameChange: observer('cluster.name', function(){
    if (!this.cluster.annotations){
      set(this.cluster, 'annotations', {})
    }
    this.cluster.annotations[OWNER_NAME] = get(this, 'cluster.name');
  }),
