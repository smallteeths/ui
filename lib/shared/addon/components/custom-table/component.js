...
export default Component.extend(StickyHeader, {
  ...
  // Table content
  fullColspan: computed('headers.length', 'internalBulkActions', 'hasRowActions', function() {
    return (get(this, 'headers.length') || 0) + (get(this, 'internalBulkActions') ? 1 : 0 ) + (get(this, 'hasRowActions') ? 1 : 0);
  }),
