...
const CUSTOM_OBJ_TO_YAML_KEY_MAP = { enableF5CIS: 'enable_f5_cis' };

const CUSTOM_YAML_TO_OBJ_KEY_MAP = { enable_f5_cis: 'enableF5CIS' };
...
export default InputTextFile.extend(ManageLabels, ClusterDriver, {
  ...
  initExternalFlags() {
    if (!get(this, 'cluster.externalFlags')) {
      set(this, 'cluster.externalFlags', { disablePortCheck: false });
    }
  }
});
