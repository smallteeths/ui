...
export default PercentGauge.extend(ThrottledResize, {
  ...
  didInsertElement() {
    set(this, 'svg', initGraph({
      ...
      // pandaria
      tooltipText:      get(this, 'tooltipText'),
      LiveTitleTooltip: get(this, 'LiveTitleTooltip'),
    }));
  ...
  updateLiveLabel: observer('liveTitle', 'LiveTitleTooltip', function() {
    get(this, 'svg').updateLiveLabel(get(this, 'liveTitle'), get(this, 'LiveTitleTooltip'));
  }),
