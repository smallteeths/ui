...
export default Service.extend({
  ...
  fetchTags(param) {
    ...
    return get(this, 'globalStore').rawRequest({
      headers: { 'X-API-Harbor-Admin-Header': !!get(this, 'access.me.hasAdmin') },
      url:     `/meta/harbor/${ get(this, 'harbor.harborServer').replace('//', '/').replace(/\/+$/, '') }/api${ get(this, 'harborVersion') }/projects/${ param.project_name }/repositories/${ repoName }/artifacts?with_tag=true&with_scan_overview=true&with_label=true&page_size=${ param.page_size }&page=${ param.page }`,
    })
  },
