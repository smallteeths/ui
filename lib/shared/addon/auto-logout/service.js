...
export default Service.extend({
  ...
  timeout: computed('settings.ui-session-logout-minutes', function() {
    return parseInt(get(this, 'settings.ui-session-logout-minutes')) * 1000 * 60
  }),
  errorTitle: computed('intl.locale', function() {
    return get(this, 'intl').t('growl.autoLogout.title')
  }),
  errorMessage: computed('intl.locale', 'timeout', function() {
