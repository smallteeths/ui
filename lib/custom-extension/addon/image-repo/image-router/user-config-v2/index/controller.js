...
export default Controller.extend({
  ...
  configActions: computed('hasHarborRegistry', 'hasHarborAccountError', 'harborAccountState', 'methodNotSupported', function() {
  ...
  methodNotSupported: computed('model.harborSystemInfo', 'access.principal.id', function() {
