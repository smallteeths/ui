...
export default Controller.extend({
  ...
  configActions: computed('hasHarborRegistry', 'harborAccountState', 'methodNotSupported', function() {
    if (this.methodNotSupported) {
      return []
    }
    if (get(this, 'hasHarborRegistry') && get(this, 'harborAccountState') === syncedHarborAccount  && get(this, 'isDBAuthMode')) {
      return [
        {
