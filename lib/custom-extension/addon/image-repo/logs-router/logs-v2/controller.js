...
export default Controller.extend({
  ...
  headers:                [
    ...
    {
      name:           'resource',
      translationKey: 'harborConfig.table.resource',
      sort:            true,
    },
    {
      name:           'resource_type',
      translationKey: 'harborConfig.table.type',
      sort:            true,
    },
    {
      name:           'operation',
  ...
  selectData: computed('intl.locale', function() {
    ...
    {
      Label:          intl.t('harborConfig.form.search.resource'),
      value:          'resource'
    },
    {
      Label:          intl.t('harborConfig.form.search.type'),
      value:          'resource_type'
    },
    {
