...
export default Controller.extend({
  ...
  availableActions: [
    ...
    // },
    {
      ...
      active(selectedRows) {
        ...
        return get(this, 'model.currentUser.has_admin_role') || roleId === '1' || roleId === '4';
      },
    },
  ],
  headers:          [
    {
      name:           'name',
      translationKey: 'harborConfig.table.imageTag',
      sort:           ['name'],
    },
    {
      name:            'size',
    ...
    {
      name:            'author',
      translationKey:  'harborConfig.table.author',
      sort:             ['size'],
    },
    {
      name:            'created',
    ...
    {
      name:            'docker_version',
      translationKey:  'harborConfig.table.dockerVersion',
      sort:             ['docker_version'],
    },
    {
      name:           'labels',
      translationKey:  'harborConfig.table.label',
    },
  ],
  ...
  data: computed('model.tags', 'name', 'page', 'prefs.tablePerPage', 'totalCount', function() {
    ...
    if (name) {
      ...
      set(this, 'totalCount', rawData.length)
    }
