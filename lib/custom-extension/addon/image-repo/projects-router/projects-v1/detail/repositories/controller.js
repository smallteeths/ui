...
export default Controller.extend({
  ...
  headers:                [
    {
      name:           'name',
      translationKey: 'harborConfig.table.name',
      sort:            true,
    },
    {
      name:            'tags_count',
      translationKey:  'harborConfig.table.tagCount',
      sort:            true,
    },
    {
      name:           'pull_count',
      translationKey: 'harborConfig.table.downCount',
      sort:            true,
    },
  ],
  availableActions: [
    {
      ...
      active(selectedRows) {
        ...
        return get(this, 'model.currentUser.has_admin_role') || get(this, 'model.currentUserRoleId') === '1' || get(this, 'model.currentUserRoleId') === '4';
      }
    },
  ],
  actions:     {
  ...
  isSystemAdmin: computed('model.currentUser.has_admin_role', function() {
  ...
  isLimitedGuest: computed('isSystemAdmin', 'model.currentUserRoleId', function() {
    if (get(this, 'isSystemAdmin')) {
      return false;
    } else {
      return parseInt(get(this, 'model.currentUserRoleId'), 10) === 5;
    }
  }),
