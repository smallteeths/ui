...
export default Controller.extend({
  ...
  actions:     {
    ...
    changeRole(roleId) {
      ...
      get(this, 'harborV2').projectChangeRole(get(this, 'model.projectId'), members, { role_id: roleId }).then(() => {
    ...
    confirmDelete() {
      ...
      get(this, 'harborV2').projectDeleteMemberRole(get(this, 'model.projectId'), members).then(() => {
  ...
  roleArr: computed('intl.locale', 'model.harborVersion.{supportRoleLimitedGuest,supportRoleMaster}', function() {
  ...
  selectedMembersWithoutSelf: computed('model.currentUser.user_id', 'selectedRows.[]', function() {
  ...
  disableActions: computed('model.currentUser.{sysadmin_flag,user_id}', 'model.currentUserRoleId', 'selectedRows.[]', function() {
    const selectedRows = get(this, 'selectedRows') || [];
    const hasProjectAdminRole = get(this, 'model.currentUser.sysadmin_flag') || `${ get(this, 'model.currentUserRoleId') }` === '1';
