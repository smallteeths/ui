...
export default Controller.extend({
  ...
  maintainerCount: computed('model.summary.master_count', 'model.summary.maintainer_count', function() {
    return get(this, 'model.summary.maintainer_count') || get(this, 'model.summary.master_count')
  }),
