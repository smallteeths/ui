  ...
  availableActions: [
    {
      ...
      active(selectedRows) {
        ...
        return get(this, 'model.currentUser.sysadmin_flag') || get(this, 'model.currentUserRoleId') === '1' || get(this, 'model.currentUserRoleId') === '4';
      }
    },
  ],
  actions:     {
    ...
    confirmDelete() {
      ...
      if (repos && repos.length > 0) {
        get(this, 'harborV2').deleteRepos(repos.map((p) => p.name), get(this, 'model.repo.name')).then(() => {
