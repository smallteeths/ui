...
export default Component.extend({
  ...
  actions:               {
    save(callback) {
      ...
      Object.assign(params, {
        ...
        role_id:     parseInt(get(this, 'role'), 10)
      })
      get(this, 'harborV2').addProjectUser(params, get(this, 'projectId')).then(() => {
        ...
        if (err.body && err.body.errors && err.body.errors[0] && err.body.errors[0].message) {
          set(this, 'errors', [err.body.errors[0].message])
        } else {
  ...
  checkRadio: computed('harborVersion.{supportRoleLimitedGuest,supportRoleMaster}', 'intl.locale', function() {
    ...
    if (this.harborVersion.supportRoleMaster) {
      arr.push({
        id:      '4',
        checked:   'false',
    ...
    if (this.harborVersion.supportRoleLimitedGuest) {
      arr.push({
        id:      '5',
        checked:   'false',
  ...
  searchMember: debouncedObserver('username', function() {
    ...
    get(this, 'harborV2').fetchProjectMembers(get(this, 'projectId'), username).then((resp) => {
