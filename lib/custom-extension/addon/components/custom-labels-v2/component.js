...
export default Component.extend({
  ...
  actions:  {
    ...
    confirmEdit() {
      get(this, 'harborV2').eidtLabels(get(this, 'editingLabel')).then(() => {
    ...
    confirmDelete() {
      get(this, 'harborV2').removeLabels(get(this, 'selectedLabels').map((label) => label.id)).then(() => {
  ...
  scope: computed('labelParam.scope', function() {
    return get(this, 'labelParam.scope') || 'g';
  }),
  projectId: computed('labelParam.project_id', function() {
    return get(this, 'labelParam.project_id') || 0;
  }),
  data: computed('page', 'prefs.tablePerPage', 'rawData', 'totalCount', function() {
  ...
  refreshData(searchText) {
    get(this, 'harborV2').fetchLabels(get(this, 'param')).then((resp) => {
      let data = resp.body;
      ...
      set(this, 'totalCount', data.length)
    });
  },
