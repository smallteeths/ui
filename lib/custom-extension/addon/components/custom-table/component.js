...
export default Component.extend(StickyHeader, {
  ...
  // Table content
  fullColspan: computed('data', 'hasBulkActions', 'hasRowActions', 'headers.length', function() {
    return (get(this, 'headers.length') || 0) + ((get(this, 'hasBulkActions') &&  get(this, 'data') && get(this, 'data').length > 0) ? 1 : 0 ) + (get(this, 'hasRowActions') ? 1 : 0);
  }),
