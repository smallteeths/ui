...
export default Component.extend(StickyHeader, {
  ...
  internalBulkActions: function(){
    ...
    if (bulkActions && get(this, 'pagedContent')){
      let pagedContent = get(this, 'pagedContent');

      return !!pagedContent.get('length');
    } else {
      return false;
    }
  }.property('hasBulkActions', 'pagedContent.[]'),
  ...
  indexTo: computed('indexFrom', 'perPage', function() {
    return Math.min(get(this, 'pagedContent.length'), get(this, 'indexFrom') + get(this, 'perPage') - 1);
  }),
