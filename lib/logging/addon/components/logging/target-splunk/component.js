...
export default Component.extend({
  ...
  originalType:  alias('originalModel.targetType'),
  origtnalToken: alias('originalModel.splunk.config.token'),
  didInsertElement() {
...
${ fieldsStr }
  ...
  tokenPlaceholder: computed('intl.locale', 'originalType', 'origtnalToken', function() {
    const intl = get(this, 'intl');

    return this.originalType === 'splunk' && !this.origtnalToken ? '******' : intl.t('loggingPage.splunk.tokenPlaceholder');
  }),
});
