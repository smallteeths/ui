...
export default Component.extend(NewOrEdit, Parse, {
  ...
  currentFluentdLogDir:    reads('scope.currentCluster.fluentdLogDir'),
...
`
  ...
  fulentdLogDirMessage: computed(function() {
    const { intl } = this

    return `${ intl.t('loggingPage.configureFluentdLogDir', {
      path:     '/var',
      htmlSafe: true,
    }) }${ intl.t('loggingPage.editIt') }`
  }),
