...
export default Controller.extend(NewOrEdit, {
  ...
  setModelPassWord: observer('password', function() {
  ...
  willSave() {
    ...
    if (!get(this, 'model.account.password')) {
      errors.push(get(this, 'intl').t('accountsPage.new.errors.pwReq'));
    ...
    set(this, 'model.account.password', get(this, 'access').encryptPassword(get(this, 'model.account.password').trim()));
