...
export default Component.extend(ViewNewEdit, {
  ...
  willSave() {
    ...
    const { cloudCredentialType }      = this;
    const keysThatWeCanValidate = ['alibaba', 'amazon', 'digitalOcean', 'linode', 'oci', 'google', 'azure', 'tencent'];
    const auth                  = {
      type:  'validate',
      token: null,
    };
