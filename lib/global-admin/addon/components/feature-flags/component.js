...
const TEMP_FEATURE_DESCRIPTIONS = [
  ...
  {
    feature:                   'proxy',
    descriptionTranslationKey: 'featureFlags.features.proxy'
  },
  {
    feature:                   'management-resource-api-cache',
    descriptionTranslationKey: 'featureFlags.features.managementResourceApiCache'
  },
]
