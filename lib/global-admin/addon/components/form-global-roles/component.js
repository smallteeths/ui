...
const LOGIN_ACCESS_ROLES = [
  ...
  },
  {
    ...
    translationKey:            'formGlobalRoles.mode.readOnlyAdmin.label',
    descriptionTranslationKey: 'formGlobalRoles.mode.readOnlyAdmin.detail',
  },
];
...
export default Component.extend({
  ...
  baseRoles: computed('allRoles.[]', function() {
    ...
    return [ADMIN, RESTRICTED_ADMIN, USER, BASE, READ_ONLY_ADMIN].map((r) => allRoles.findBy('id', r)).compact();
  }),
