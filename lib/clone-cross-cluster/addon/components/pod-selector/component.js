...
export default Component.extend({
  ...
  init() {
    ...
    // !selectedNamespaces use to determine namespace is unset
    if (!selectedNamespaces || !(selectedNamespaces && selectedNamespaces.length === 1 && selectedNamespaces[0] === get(this, 'currentNamespace')) ) {
