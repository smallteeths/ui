...
export default Component.extend({
  ...
  nodePortRangeDidChange: observer('intl.locale', 'rkeConfig.services.kubeApi.serviceNodePortRange', function() {
    const intl          = get(this, 'intl');
    const nodePortRange = get(this, 'rkeConfig.services.kubeApi.serviceNodePortRange')
