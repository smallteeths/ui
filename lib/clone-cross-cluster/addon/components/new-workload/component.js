...
export default Component.extend({
  ...
  allSecrets: computed('projectSecrets.[]', 'namespaceSecrets.[]', 'service.namespaceId', function() {
    return [...this.projectSecrets.slice(), ...this.namespaceSecrets.filter((item) => item.namespaceId === this.service.namespaceId).slice()];
  }),
